...
$(document).ready(function(){
   ...
   function slowFastSlowRange(begin, end, total_points){
       ...
       **/
      let unit_degree  = (Math.PI/2) / total_points; // in radian
      let output_range = [];
      ...
      for (let i = 1; i <= total_points; i++) {
         ...
         let normalized_point    = parseFloat(Math.cos(radian_point).toFixed(3));
         let scaled_point        = normalized_point * total_points;
   ...
   console.log(slowFastSlowRange(50,150,100));
